...
from DAOs.ConfigDB import salva_compromisso
...
class NotaCompromisso(BoxLayout):
    ...
    def guardar_compromisso(self, *args):
        ...
        compromisso = {'Titulo': ids_compromisso['Titulo'].text, 'Data': analisa_data(ids_compromisso['Hora'].text),
                       'Anotacao': ids_compromisso['Anotacao'].text, 'Cor': ''}
